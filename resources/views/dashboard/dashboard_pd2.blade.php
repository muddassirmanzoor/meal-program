...
<div class="container-fluid">
                        ...
                        <form id="filterForm" method="POST" action="{{ route('dashboard2') }}">  
                            @csrf
                            <div class="row">                              
                                    ...
                                    <div class="col-lg-3 ">
                                        <div class="card widget-flat">
                                            <div class="card-body">
                                                ...
                                                <h5 class="text-muted fw-normal mt-0 dashboard-card-heading" title="Number of Customers">Health Profile</h5>
                                    ...
                                    <div class="col-lg-3 ">
                                        <div class="card widget-flat">
                                            <div class="card-body">
                                                ...
                                                <h5 class="text-muted fw-normal mt-0 dashboard-card-heading" title="Number of Customers">School Count Inventory Wise</h5>
                                                <h3 class="mt-3 mb-3">Received Inventory: {{number_format($total_schools[0]->total_schools == '' ? '0': $total_schools[0]->total_schools - $metro_pending_delivery_schools[0]->metro_pending_delivery_schools)}}</h3>
                                                <h3 class="mt-3 mb-3">Pending Schools: {{number_format($metro_pending_delivery_schools[0]->metro_pending_delivery_schools == '' ? '0': $metro_pending_delivery_schools[0]->metro_pending_delivery_schools)}}</h3>
                                            </div> <!-- end card-body-->
                                        </div> <!-- end card-->
                                    </div> <!-- end col-->
                                    ...
                                    <div class="col-lg-3 ">
                                        <div class="card widget-flat">
                                            <div class="card-body">
                                                <div class="float-end">
                                                    <span class="widget-icon">
                                                        <img src="assets/images/shipped.png" alt="" height="32">
                                                    </span>
                                                </div>
                                                <h5 class="text-muted fw-normal mt-0 dashboard-card-heading" title="Number of Orders">Delivered by Metro</h5>
                                                <h3 class="mt-3 mb-3">{{number_format($metro_delivered_inventory[0]->metro_delivered_inventory == '' ? '0': $metro_delivered_inventory[0]->metro_delivered_inventory)}} <small>(in {{$metro_delivered_inventory[0]->no_of_days}} days)</small></h3>
                                            </div> 
                                        </div> <!-- end card-->
                                    </div> <!-- end col-->
                                    <div class="col-lg-3 ">
                                        <div class="card widget-flat">
                                            <div class="card-body">
                                                <div class="float-end">
                                                    <span class="widget-icon">
                                                        <img src="assets/images/received-box.png" alt="" height="32">
                                                    </span>
                                                </div>
                                                <h5 class="text-muted fw-normal mt-0 dashboard-card-heading" title="Number of Orders">Received by Schools</h5>
                                                <h3 class="mt-3 mb-3">{{number_format($total_inventory_received[0]->total_quantity_received == '' ? '0': $total_inventory_received[0]->total_quantity_received)}} <small>(in {{$total_inventory_received[0]->no_of_days}} days)</small></h3>
                                            </div> 
                                        </div> <!-- end card-->
                                    </div> <!-- end col-->  
                                    <div class="col-lg-3 ">
                                        <div class="card widget-flat">
                                            <div class="card-body">
                                                ...
                                                <h3 class="mt-3 mb-3">{{number_format($total_consumed[0]->total_consumed == '' ? '0': $total_consumed[0]->total_consumed)}} <small>(in {{$total_consumed[0]->no_of_days}} days)</small></h3>
                                            </div> <!-- end card-body-->
                                        </div> <!-- end card-->
                                    </div> <!-- end col-->                             
                                    <div class="col-lg-3 ">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title stat-boxes-heading">Today's Stats {{date('Y-m-d')}}</h4>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                    ...
                                    <div class="col-lg-3 ">
                                        <div class="card widget-flat">
                                            <div class="card-body">
                                                ...
                                                <h5 class="text-muted fw-normal mt-0 dashboard-card-heading" title="Number of Customers">Packs Delivered By Metro</h5>
                                    ...
                                    <div class="col-lg-3 ">
                                        <div class="card widget-flat">
                                            <div class="card-body">
                                                ...
                                                <h3 class="mt-3 mb-3 today-detail-text">{{number_format($total_consumed_today[0]->total_consumed_today == '' ? '0': $total_consumed_today[0]->total_consumed_today)}}
                                                <small>({{number_format(($total_consumed_today[0]->total_consumed_today / $total_consumed_today[0]->total_present_today) * 100, 2)}}% covered w.r.t. today's Attendance)</small>
                                                </h3>
                                            </div> 
                                        </div> <!-- end card-->
                                    </div> <!-- end col-->
                         ...
                         <div class="row">
                            <div class="col-xl-12 col-lg-12">
                                <div class="card">
                                    <div class="card-body">                                     
                                        <h4 class="header-title mb-3">Date Wise Inventory Stats</h4>        
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12">
                                <div class="card">
                                    <div class="card-body">                                     
                                        <h4 class="header-title mb-3">District Wise Utilization</h4>        
...
<script type="text/javascript">
    ...
    <script type="text/javascript">
        ...
        var lineGraphData = @json($line_graph);
        ...
        // Process data to extract chart values
        lineGraphData.forEach(function(item) {
            graph_date.push(item.dates); // District names for x-axis
            total_received.push(parseInt(item.total_received)); // Inventory data
            total_consumed.push(parseInt(item.total_consumed)); // Utilization data
           
        });

        $('#inventorystats').highcharts({
        title: {
            text: '',
            align: 'left'
        },
